...
void CALLBACK FP_OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    if( SUCCEEDED( pd3dDevice->BeginScene() ) )
    {
        ...
        V( g_pEffect9->SetValue( g_hLightDir, g_GUI.m_vLightDir, sizeof(D3DXVECTOR3)*FP_MAX_LIGHTS ) );
        ...
        //pd3dDevice->SetRenderState(D3DRS_POINTSPRITEENABLE, 1);
        //pd3dDevice->SetRenderState(D3DRS_POINTSCALEENABLE, 0);
        //pd3dDevice->SetRenderState(D3DRS_SRCBLEND, D3DBLEND_SRCALPHA);
        //pd3dDevice->SetRenderState(D3DRS_DESTBLEND, D3DBLEND_ONE);
        //pd3dDevice->SetRenderState(D3DRS_ALPHABLENDENABLE, 1);
        //for(int i=0; i<g_nPaticles; i++) {
        //    pd3dDevice->DrawPrimitiveUP(D3DPT_POINTLIST, g_nPaticles, g_pvParticle, sizeof(D3DXVECTOR3));
        //}
