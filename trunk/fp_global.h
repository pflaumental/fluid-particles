...
#define FP_MC_INITIAL_GRID_SIDELENGTH 50
#define FP_MC_INITIAL_GRID_CAPACITY FP_MC_INITIAL_GRID_SIDELENGTH \
        * FP_MC_INITIAL_GRID_SIDELENGTH * FP_MC_INITIAL_GRID_SIDELENGTH
...
#define FP_RAYCAST_DEFAULT_VOXEL_SIZE 2.0f * FP_GLASS_RADIUS\
        / FP_RAYCAST_VOLUME_TEXTURE_WIDTH
#define FP_RAYCAST_GLASS_FLOOR_OFFSET 0.0f
